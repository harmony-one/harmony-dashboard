...
export const EXPLORER_BACKEND_URL = `https://explorer.harmony.one:8888`
export const DASHBOARD_BACKEND_URL = `https://explorer.harmony.one:8888`
export const INSIGHT_BACKEND_URL = `http://54.187.20.215:8081`
export const EXPLORER_BACKEND_WS = `wss://explorer.harmony.one:8888`
